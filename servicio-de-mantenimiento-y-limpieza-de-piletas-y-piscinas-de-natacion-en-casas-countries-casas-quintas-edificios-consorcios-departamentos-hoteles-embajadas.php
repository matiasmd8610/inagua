    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-lg-6 div-texto-casas-bac">
            ...
            <h5 class="texto3sc wow slideInUp" style="margin-top: 50px;">Para realizar este servicio podemos utilizar su
              equipo o contamos con el propio.</h5>

            <h5 class="texto3sc wow slideInUp" style="margin-top: 50px; margin-bottom: 50px;">El personal de INAGUA está
