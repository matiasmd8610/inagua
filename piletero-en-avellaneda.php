...
<head>
  ...
  <meta name="title" content="Piletero en Avellaneda">
  ...
  <title>Piletero en Avellaneda</title>
  ...
  <section id="cobertura">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="div-texto">
            <h1 class="texto1 wow zoomInDown" datos-wow-duracion="2s" data-wow-delay="1s">Mantenimiento de Piletas en Avellaneda</h1>
          </div>
        </div>
      </div>
    </div>
