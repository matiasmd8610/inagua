...
<html lang="es">
	...
	<head>
		...
		<meta name="title" content="SERVICIO DE LIMPIEZA DE PILETAS- SERVICIOS DE PILETEROS" />
		<meta name="author" content="Administrator" />
		<meta name="description" content="Desagote. Limpieza. Mantenimiento. Desinfección. Recuperación. Cambio de arena. Analisis. Productos y accesorios." />	
		<title>SERVICIO DE LIMPIEZA DE PILETAS- SERVICIOS DE PILETEROS</title>	
		...
		<div id="contenedor">
			...
			<div id="centro">
				...
				<div id="columna-uno">	
					...
					<h1>
						¿QU&Eacute; SERVICIOS BRINDA INAGUA?
					</h1>
					...
					<?php
						...
						if (file_exists("includes/lista_de_servicios.php")) {
							include("includes/lista_de_servicios.php");
						} else
							{
							echo "<p class='no_enc'>Archivo no encontrado</p>";
							}
