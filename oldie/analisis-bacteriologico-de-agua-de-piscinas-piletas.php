...
<html lang="es">
	...
	<head>
		...
		<meta name="description" content="Toma de muestra de agua de pileta a domicilio." />
		...
		<div id="contenedor">
			...
			<div id="centro">
				...
				<div id="columna-uno">	
					...
					<h1>
						ANALISIS BACTEREOLOGICO Y FISICO-QUIMICO DE AGUA
					</h1>
					...
					<p  class="txt_empresa">
						Los microorganismos causantes de problemas principalmente son los provenientes del cuerpo de los bañistas . Las infecciones potenciales pueden ser de oídos, vías respiratorias superiores, piel, aparato digestivo y urinario.
					</p>
					
					<p  class="txt_empresa">
						Para verificar su seguridad se debe realizar determinación de:
					</p>
					...
					<p  class="txt_empresa">
						...
						- pH
						<br/>
						- Recuento en placa de heterótrofas
						<br/>
						- Coliformes fecales
						<br/>
						- Investigación de Eschirichia coli
						<br/>
						- Investigación de Enterococcus, Staphylococcus, Pseudomonas
					</p>
