<div class="container">
  <div class="row">
    ...
    <div class="col-md-12">		
      <div class="div-texto">
          <h1 class="texto1 wow zoomInDown" datos-wow-duracion= "2s" data-wow-delay = "1s">PRODUCTOS PARA EL CUIDADO DEL AGUA DE LA PILETA :: FUENTE: ANMAT</h1>
      ...
      <div class="container">
        ...
        <div class="div-texto texto-art wow slideInUp">
             <p class="texto31 ">
               Durante el verano, resulta habitual el uso de las piletas de natación para combatir el calor y como modo de esparcimiento. Sin embargo, para evitar problemas para la salud, es necesario tener en cuenta algunas recomendaciones necesarias para el buen mantenimiento del agua de las piscinas.
                 
          
<br><br>
              A través del agua pueden transmitirse enfermedades como otitis, conjuntivitis y diversas infecciones intestinales. El mantenimiento del agua en condiciones saludables ayuda a prevenir esos inconvenientes, y para ello es necesario utilizar una serie de productos para evitar por ejemplo la presencia de bacterias y algas.
<br><br>
              Clases de productos
<br><br>
...
<br><br>
          ...
          A fin de asegurar la efectividad de los productos para piscinas, es muy importante respetar estrictamente las indicaciones del rótulo, en lo que se refiere a dosificación, precauciones y condiciones de almacenamiento. Además, siempre deben mantenerse fuera del alcance de los niños y de las mascotas.
<br><br>
          <b>Cloro</b>  
...
<br>
 ...
 <br>
          El nivel de cloro debe mantenerse en 2 partes por millón (ppm). No es aconsejable que se encuentre en un valor mayor y, por otra parte, los bajos niveles de cloro pueden permitir el desarrollo de bacterias. 
...
<br>
          En las piletas de natación es importante controlar el pH del agua al menos una vez por semana, utilizando el kit de medición, pues ello influye directamente en la efectividad del cloro.  
<br>
...
<br>
          Por eso, resulta necesario añadir periódicamente la dosis adecuada de alguicida, sobre todo cada vez que se renueve el agua de la piscina.   
<br><br>
         <b>Floculantes  </b>  
...
<br><br>
        ...
        <br>
<div class="texto31">       
Fuente:<b> ANMAT - Administración Nacional de Medicamentos, Alimentos y Tecnología Médica<a href="http://www.anmat.gov.ar/Domisanitarios/Productos_para_piletas.pdf" target="new" style="margin-left: "> DOCUMENTACION - ANMAT </a></b>
</div>
...
<br><br>
                ...
                <div class="fb-comments" data-href="http://inagua.com.ar/articulo.php?id=40" data-width="100%" data-numposts="3"></div>
