                    ...
                    <div class="col-md-3 wow fadeIn" datos-wow-duracion="3s" data-wow-delay="3s">
                        <table width="100%" border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" class="td08b">
                                        <p>Vaciamos, limpiamos y desinfectamos su pileta de natación dejandola lista
                                            para llenar o pintar</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                    ...
                    <div class="col-md-3 wow fadeIn" datos-wow-duracion="4s" data-wow-delay="4s">
                        <table width="100%" border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="reparacion-de-bomas-autocebantes-de-piletas.php">
                                            <p class="boton-click-aqui">MÁS INFO</p>
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <div class="col-md-3 wow fadeIn" datos-wow-duracion="3s" data-wow-delay="3s">
                        <table width="100%" border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="cambio-de-multivalvula-selectora-de-filtro.php">
                                            <p class="boton-click-aqui">MÁS INFO</p>
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <div class="col-md-3 wow fadeIn" datos-wow-duracion="4s" data-wow-delay="4s">
                        <table width="100%" border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="servicio-integrales-de-mantenimiento-de-piletas-y-afines.php">
                                            <p class="boton-click-aqui">MÁS INFO</p>
                                        </a>
                                    </td>
                                </tr>
