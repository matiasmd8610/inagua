      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="div-texto-casas-bac">
            ...
            <h5 class="texto3sc wow slideInUp">
              Conocemos la problemática de los mismos, por lo tanto hemos implementado un sistema a la medida de sus
              necesidades.
            </h5>
            <h5 class="texto3sc wow slideInUp">
              Brindamos diferentes frecuencias de servicios de mantenimineto de piletas dependiendo de las necesidades
              de cada cliente.
            </h5>
            <h5 class="texto3sc wow slideInUp">
            ...
            <h5 class="texto3sc wow slideInUp">
              ...
              Vida Obligatorio Sancor Seguros – Seguro de vida del personal- Póliza N° 1291680 - Ref. 1183029
            </h5>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 lugar_char" align="center">
          ...
          <div class="btn_zona">
            <p class="boton-zona">
              <a href="http://inagua.com.ar/piletero-en-capital-federal.php" target="_blank">CONSULTA POR SERVICIOS EN
                TU ZONA</a>
            </p>
          </div>
        </div>
