      ...
      <div class="container">
              <div class="row">
                  <div class="col-md-12">   
                    ...
                    <div class="div-texto">
                      <h1 class="texto1 wow zoomInDown" datos-wow-duracion= "2s" data-wow-delay = "1s">Preguntas frecuentes + Tips utiles sobre piscinas y salud pública</h1>
                        <h4 class="texto2 wow slideInUp">conozca mas sobre su piscina</h4>
                    </div>
                    <br><br>
             ...
             <p class="texto313 wow slideInUp">
                En Inagua contamos con esta sección donde encontrarás toda la información que necesites para el cuidado de tu pileta y algunas notas de color del mundo de las piscinas. Los principales problemas que surgen en torno a la piscina están relacionados generalmente con el estado del agua o con el funcionamiento de equipos y accesorios. Decidimos realizar un análisis de las preguntas frecuentes de nuestros clientes y público en general ofreciendo las soluciones más prácticas y efectivas.
                  <br>
