		...
		<div id="contenedor">
			...
			<div id="centro">
				...
				<div id="columna-uno">	
					...
					<h1>
						INAGUA - EMPRESA DE PILETEROS PROFESIONALES
					</h1>
					...
					<p  class="txt_empresa">
						Nos especializamos en <span class="bold">limpieza y desinfección de piletas en la Ciudad Autónoma de Buenos Aires</span>.
					</p>
					<p  class="txt_empresa">
						Nuestro objetivo es satisfacer todas sus necesidades en lo que respecta a la <span class="bold">limpieza de su pileta</span>, manteniendo la atención y el profesionalismo en todo momento. 
					</p>
					<p  class="txt_empresa">
