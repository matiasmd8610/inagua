...
$mailprog = '/opt/exim/bin/exim -t';

# @referers allows forms to be located only on servers which are defined     #
# in this field.  This security fix from the last version which allowed      #
# anyone on any server to use your FormMail script on their web site.        #

@referers = ('inagua.com.ar','limpieza-piletas.com.ar','inagua.ferozo.com','200.58.111.84');
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        <center><font size=-1><a href="http://www.scriptarchive.com/readme/formmail.html#form_config"><h2>Manual de FormMail</h2></a> V1.92 &copy; 1995 - 2002  Matt Wright<br>
