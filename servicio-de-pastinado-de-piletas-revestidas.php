      ...
      <div class="container">
              <div class="row">
                  <div class="col-md-12">   
                    ...
                    <div class="div-texto">
                      <h2 class="texto1 wow zoomInDown" datos-wow-duracion= "2s" data-wow-delay = "1s"> Pastinado de piletas revestidas con venecitas</h2>
                  ...
                  <br>
                      ...
                      <div class="div-texto">
                          <h5 class="texto3 wow slideInUp">
                                Las piletas revestidas con mosaicos venecianos (comúnmente conocidos como venecitas), con el transcurso del tiempo y por agresión de diferentes agentes químicos, van perdiendo el material de las juntas, lo que produce el desprendimiento de los mismos. Le ofrecemos el trabajo de tomado de juntas realizado con materiales de primera calidad, colocando pastina en las uniones y dejando el revestimiento como nuevo.
                          </h5>
                    </div>
                      <br>
