  ...
  <section id="cloradores-salinos">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="div-texto">
            <h1 class="texto1 wow zoomInDown" datos-wow-duracion="2s" data-wow-delay="1s">Cloradores salinos para
              piscinas</h1>
            <h2 class="texto2 wow slideInUp">Nuevo tratamiento alternativo para el cuidado, mantenimiento y desinfección del agua.
            </h2>

            <br><br>
            <h5 class="texto3 wow slideInRight" datos-wow-duracion="2s" data-wow-delay="1s">¡AGUA LIMPIA Y
              SANA PARA TU PISCINA TODO EL AÑO!</h5>
            <p class="texto3 wow slideInUp">Sin necesidad de cambiar nunca más el agua de tu piscina ni de añadir cloro en forma manual.</p>

            <h5 class="texto3 wow slideInLeft" datos-wow-duracion="2s" data-wow-delay="1s">¡COTIZÁ TU
              PROYECTO HOY SIN CARGO!</h5>
            <p class="texto3 wow slideInUp">Proporcionamos asesoramiento de calidad y un valioso acompañamiento técnico en los proyectos a medida de
              nuestros clientes.</p>
            <p class="texto3 wow slideInUp">Contamos con el respaldo de Innowater S.L. abocada al desarrollo y la fabricación de productos de alta
            ...
            <ul class="texto3 wow slideInUp">
              ...
              <li>La relación directa y eficaz que se establece con el usuario final, explica la gran fidelidad y
                satisfacción de todos aquellos con quienes trabajamos.</li>
            </ul>

            <p class="texto3 wow slideInUp">Nuestros cloradores salinos utilizan componentes de máxima calidad y tecnología de última generación.</p>

            <p class="texto3 wow slideInUp">Innowater produce y desarrolla todos sus equipos en España y utiliza proveedores y componentes de la
              máxima calidad. Al integrar todas las fases claves del desarrollo y de la fabricación, como el diseño
              mecánico y electrónico, el desarrollo de software o el ensamblado completo del producto.</p>

            <p class="texto3 wow slideInUp">Innowater consigue un excepcional control del producto final que se traduce en su gran calidad y
              adaptabilidad.</p>
        ...
        <!-- FAQS: Begin -->
        <h2 class="texto1 wow zoomInDown mb-5" datos-wow-duracion="2s" data-wow-delay="1s">F.A.Q PREGUNTAS FRECUENTES
        </h2>
        <div class="accordion mb-5" id="accordionExample">
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                Proceso mediante el cual una corriente eléctrica transforma la sal (NaCl) y el agua (H2O) en cloro
                gaseoso (Cl2).
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Dentro de la célula electrolítica, que debe instalarse después del filtro de arena, en la cañería de
                retorno del agua a la piscina. El tablero es el instrumento que administra la corriente eléctrica para
                que esto se produzca. El uso del CLORADOR SALINO INNOWATER permite tener en la piscina un circuito
                cerrado para el mantenimiento del agua, sustentable y de muy simple instalación.
                <br>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Evita los riesgos de la inadecuada utilización de productos químicos. La electrólisis salina no utiliza
                productos químicos industriales por lo que no hay peligro de intoxicación. La única materia prima
                utilizada es la sal que no necesita almacenamiento.
                <br>
                Calidad del agua. <br>
                Además de desinfectar, la electrólisis elimina bacterias, algas y hongos con un agua más cristalina.
                También elimina cloraminas, responsables del mal olor y de la irritación de piel y ojos.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Protege el medio ambiente porque recicla todos los elementos. La electrolisis salina parte de la
                utilización de dos elementos naturales, agua y sal, no contaminantes, respetuosos con el Medio Ambiente,
                y una energía limpia como es la electricidad. Además permite el reciclaje de ambos elementos
                reconvirtiéndose nuevamente en sal y agua, y así sucesivamente.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                El consumo es equivalente a una bombilla y sin necesidad de vaciar la piscina. Así, está probado que los
                sistemas de electrólisis salina permiten un ahorro del 80% en mantenimiento y un 100% en productos
                químicos.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                La electrólisis salina es válida para cualquier lugar en el que exista la necesidad de cloración del
                agua.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Agregar sal y esperar 4 horas. Una vez disuelta la sal en el agua poner en marcha el equipo para
                comenzar con la producción de cloro.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                El agua salina es un suave antiséptico natural, que inhibe la formación de organismos en el agua de la
                piscina. A lo que se agrega el efecto del cloro y la formación de otros agentes oxidantes.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                No, la sal se añade al agua, pero sólo en muy bajas concentraciones. Mientras que el mar tiene 37grs por
                litro, nosotros aquí utilizamos sólo 4grs por litro.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Prácticamente no, las reacciones constituyen un proceso cerrado en el que no hay pérdida de ningún
                elemento ya que se descomponen, actúan y se vuelven a regenerar. Sólo ante descartes de agua y retro
                lavado o por limpia fondos que tiren el agua fuera de la piscina hay que agregar pequeñas cantidades
                adicionales.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Muy pequeño, y una de las ventajas de este sistema es su automatismo. Además todos los equipos
                incorporan un sistema de limpieza automática.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen"
              data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Sí. Y ésta es una de sus principales ventajas. La electrólisis salina permite un gran ahorro porque el
                agua se puede mantener años sin necesidad de cambiarla.
              </div>
            </div>
          </div>
        </div>
