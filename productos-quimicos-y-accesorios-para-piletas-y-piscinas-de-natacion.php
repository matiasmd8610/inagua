      ...
      <div class="container">
              <div class="row">
                  <div class="col-md-12">   
                    ...
                    <div class="div-texto">
                      <h1 class="texto1 wow zoomInDown" datos-wow-duracion= "2s" data-wow-delay = "1s">Productos y accesorios para piscinas</h1>
                        <h2 class="texto2 wow slideInUp">Mayorista y minorista</h2>
                    </div>
                    <br><br>
                    
                    <img src="img/imagen-productos-2.png" alt="" class="imgen-moviles-casas4">
                    


                    <div class="div-texto-casas4">
                          <h5 class="texto3sc wow slideInUp">
                                Brindamos la posibilidad a quienes contratan nuestros servicios de proveerles productos químicos para el mantenimiento del agua de su pileta y accesorios de piletas de primera calidad y de las marcas 
comerciales lideres.
                          </h5>
                          <br>
                          <h5 class="texto3sc wow slideInUp">
                               Vendemos productos y accesorios de forma mayorista y minorista.
                          </h5>
                             <br>

                          <h5 class="texto3sc wow slideInUp" >
                                Compre sus productos mediante nuestra tienda o solicite vía mail un presupuesto a su medida.
...
INAGUA 
                           ...
                           <h5 class="texto3sc wow slideInUp" >
                               <b>Teléfono: 4738.3329</b>
                          </h5>

                           <br>

                           <h5 class="texto3sc wow slideInUp">
                               O través de nuestro formulario de contacto, lo atenderemos con gusto.
                          </h5>
                          <div class="imagen-produc23 wow slideInLeft">
                          <img src="img/imagen-pro2.png" alt="">
                          </div>
                    </div>
                    <div class="imagen-produc0 wow slideInRight">

                      <img src="img/imagen-pro1.png" alt="">
                    ...
                    <div class="col-md-12 presupuesto-ser wow slideInUp"><br><br> 
                           <a href="http://tienda.inagua.com.ar/" class="boton-presupuesto" style="text-decoration:none;" target="_new" >VISITA NUESTRA TIENDA</a>                     
                          </div>
                </div>
        </div> 
</section>
