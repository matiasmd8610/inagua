...
<!-- End Google Tag Manager -->
    ...
    <meta name="theme-color" content="#2F4598">
		...
		<meta name="keywords" content="pileta, piletas, piscinas, piletero, pileteros, desagote, parque patricios" />
		<meta name="title" content="Piletero en Parque Patricios" />
...
<section id="cobertura">
      <div class="container">
              <div class="row">
                  <div class="col-md-12">   
                    <div class="div-texto">
                      <h1 class="texto1 wow zoomInDown" datos-wow-duracion= "2s" data-wow-delay = "1s">Mantenimiento de Piletas en Parque Patricios</h1>
