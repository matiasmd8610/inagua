...
<head>
  ...
  <title>INAGUA | Pileteros - Limpieza de piscinas | Error 404</title>
  ...
  <section class="page-404">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="div-texto">
            <span class="text-404 texto2">404</span>
            <h1 class="texto1 wow zoomInDown" datos-wow-duracion="2s">OPS! Esta página no existe</h1>
          </div>
          <div class="col-md-12 presupuesto-ser wow slideInUp">
            <a href="/" class="boton-presupuesto">Ir la inicio</a>
          </div>
        </div>
      </div>
    </div>
