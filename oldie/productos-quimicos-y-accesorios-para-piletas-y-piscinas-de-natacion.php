		...
		<div id="contenedor">
			...
			<div id="centro">
				...
				<div id="columna-uno">	
					...
					<p  class="txt_empresa">
						Brindamos la posibilidad a quienes contratan nuestros servicios de proveerles <span class="bold">productos químicos para el mantenimiento del agua de su pileta y accesorios de piletas</span> de primera calidad y de las marcas comerciales lideres.
					</p>
					
					<p  class="txt_empresa">
						También vendemos productos y accesorios de forma mayorista.
					</p>
					
					<p  class="txt_empresa">
						<a href="contacto.php">Solicite vía mail un presupuesto a su medida.</a>
					</p>
