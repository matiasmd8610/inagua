  ...
  <section id="revestimiento-venecitas">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="div-texto">
            <h1 class="texto1 wow zoomInDown" datos-wow-duracion="2s" data-wow-delay="1s">Revestimiento de Venecitas
            </h1>
            <p class="text-center">Revestimos piletas con venecitas. Ofrecemos una amplia gama de colores, tipos y
