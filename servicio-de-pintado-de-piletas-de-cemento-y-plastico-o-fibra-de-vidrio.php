...
<html lang="es">
  ...
  <head>
    ...
    <meta name="theme-color" content="#2F4598">
		...
		<meta name="keywords" content="pileta, piletas, piscinas, piletero, pileteros, desagote, pintura, piletas plastico, fibra de vidrio, caucho clorado" />
		<meta name="title" content="Pintor de piletas" />
		<meta name="author" content="Administrator" />
		<meta name="description" content="Servicios de pintura de piletas de material, plastico y fibra de vidrio con caucho clorado." />	
      ...
      <div class="container">
              <div class="row">
                  <div class="col-md-12">   
                    ...
                    <div class="div-texto">
                      <h1 class="texto1 wow zoomInDown" datos-wow-duracion="2s" data-wow-delay="1s">Pintado de piletas</h1>
                        <h2 class="texto2 wow slideInUp">Se efectúan trabajos de pintura sobre piletas de cemento o fibra de vidrio</h2>
                    </div>
                    ...
                    <br><br>
                      ...
                      <div class="div-texto">
                          <h5 class="texto3 wow slideInUp">
                               La pintura es fundamental para la estética y el mantenimiento, la pintura vieja se descascara y enturbia el agua, por eso una adecuada pintura mejora las condiciones. La época recomendada para pintar es agosto septiembre octubre, los meses de mucho calor hacen que se ampollen las paredes. Luego del desagote y la desinfección se procede al lijado de las paredes y piso, logrando una superficie lista para el pintado, cumpliendo con los días de secado para luego su llenado.
