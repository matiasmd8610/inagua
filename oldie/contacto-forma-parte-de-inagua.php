		...
		<div id="contenedor">
			...
			<div id="centro-contacto">
				...
				<div id="centro1">
					...
					<p class="negrita">
						Si queres formar parte de <span class="mayus">INAGUA</span> comunicate a trav&eacute;s de los siguientes medios:
					</p>
				...
				<div id="centro2">
						...
						<p class="negrita">O complet&aacute; el siguiente formulario:</p>
					
					<form id="formu-contacto" action="http://www.inagua.com.ar/cgi-bin/FormMail.cgi" method="post">	
						<div id="formu1">
							<p>
						...
						<input type="hidden" name="subject" id="subject" value="Formulario para formar parte de INAGUA" />
											
						<input type="hidden" name="recipient" id="recipient" value="info@inagua.com.ar" />
						
						<input type="hidden" name="redirect" id="redirect" value="http://www.inagua.com.ar/gracias-rrhh.php" />
						
						<input type="hidden" name="para" id="para" value="RRHH de INAGUA" />
