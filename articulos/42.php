  ...
  <div class="row">
    ...
    <div class="div-texto texto-art wow slideInUp">
      <p class="texto31 ">
        ...
        encima de las necesidades inmediatas se denomina CLORO LIBRE O RESIDUAL.
        ...
        <div class="seguinos20">
          <a href="javascript:window.open('https://www.facebook.com/sharer/sharer.php?u=http://inagua.com.ar/articulo.php?id=42','','width=600,height=400,left=50,top=50,toolbar=yes');void 0"
            rel="image_src"><img src="assets/images/logo_face.png" class="icono_face_compa" alt=""></a>
          <a href="javascript:window.open('https://twitter.com/?status= El articulo http://inagua.com.ar/articulo.php?id=42 es muy interesante. Te invito a que lo leas y compartas','','width=600,height=400,left=50,top=50,toolbar=yes');void 0""><img src="
        ...
        <div class="fb-comments" data-href="http://inagua.com.ar/articulo.php?id=42" data-width="100%"
          data-numposts="3"></div>
