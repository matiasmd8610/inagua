<section id="cobertura">
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="div-texto">
                <h2 class="texto1 wow zoomInDown" datos-wow-duracion="2s" data-wow-delay="1s">Zonas de Cobertura de Mantenimiento de Piscinas</h2>
                <h3 class="texto2 wow slideInUp">Pileteros Profesionales</h3>
            </div>
...
<section class="separ-secciones">
    <div class="div-texto">
        <h4 class="texto2 wow slideInUp text-center">Otras Localidades</h4>
    </div>
    <br>
    <div class="container">
        <div class="row wow slideInUp">
