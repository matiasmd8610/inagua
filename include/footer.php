 ...
 <div class="fondo_pie">
    ...
    <div class="container solo_pie_content">
          <!--  <div class="row">
                
                 <div class="col-md-12" align="center" >
						<img src="img/logo_foo.png" alt="" class="logo_footer_1">
       ...
       <div class="row columnas-listas-pie">
                     ...
                     <ul class="texto_pie_lis">
                     	...
                     	<li><a href="empresa-de-mantenimiento-y-limpieza-de-piscinas-de-natacion-y-piletas.php">Nosotros</a></li>
                     	<li><a href="productos-quimicos-y-accesorios-para-piletas-y-piscinas-de-natacion.php">Productos</a></li>
					...
					<div class="acordeon__item2">
						...
						<ul class="texto_pie_lis acordeon__contenido2">
							...
							<li><a href="analisis-bacteriologico-de-agua-de-piscinas-piletas.php">Analisis Bactereologico</a></li>
								...
								<div class="acordeon__item2">
									<input type="checkbox" name="acordeon2" id="item11">
									<label for="item11" class="acordeon__titulo2">WEB</label>
									  <ul class="texto_pie_lis acordeon__contenido2">
				                     	<li><a href="index.php">Inicio</a></li>
                     	<li><a href="empresa-de-mantenimiento-y-limpieza-de-piscinas-de-natacion-y-piletas.php">Nosotros</a></li>
                     	<li><a href="productos-quimicos-y-accesorios-para-piletas-y-piscinas-de-natacion.php">Productos</a></li>
                     	...
                     	<li><a href="pileteros-mantenimiento-piscinas-preguntas-frecuentes.php">Preguntas Frecuentes</a></li>
		...
		<div class="redes_footer_2">
							
			<div>
                    	
                      <div class="horario_atencion2" align="center">

				     	
				     		<img src="img/calendario2.png" alt="" class="horario_atencion_header_icon2">
				     	
			     		<div class="horario_atencion_header_tipos2">
			     			 <p class="dias_atencion2"><b>LUNES A VIERNES</b></p>
			     			 <p class="horarios_atencion2">8:00 a 17:00</p>
			     			 <p class="dias_atencion2"><b>SABADO</b></p>
			     			 <p class="horarios_atencion2">8:00 a 12:00</p>
			     		</div>
				...
				<img src="img/sello_premiun.png" class="sello_premiun2" alt="">
                  ...
                  <div style="width:100%;" align="center"> 
                   ...
                   <div class="col-md-12" style="display:flex; justify-content:center; padding-bottom:18em; padding-top:5em; margin-left:20px;">

    			<div>
          		<a href="http://qr.afip.gob.ar/?qr=1qt4s-TexwFKbGmlAD-3kA,," target="new"><img src="img/data_fiscal.png" width="44" heigth="59" alt="" class="hvr-grow img-fiscal2"></a><img src="" alt="">
          		</div>
          		...
          		<div style="padding-left:10px;" align="center">
                    ...
                    <a href="https://www.facebook.com/Inagua.Mantenimiento.de.Piscinas/" target="new" ><img src="img/logo_face.png" alt="" class="hvr-grow"></a>
                    <a href="https://twitter.com/InaguaPileteros" target="new"><img src="img/logo_tw.png" alt="" class="hvr-grow"></a>
                    <a href="https://www.instagram.com/inagua.mantenimiento/" target="new"><img src="img/logo_ins.png" alt="" class="hvr-grow"></a>
                    <a href="http://piletero.blogspot.com.ar/" target="new"><img src="img/blogger.png" alt="" class="hvr-grow"></a>
                </div>
    	...
    	<div class="col-md-12 img-fiscal">
    ...
    <!-- <a href="#top">
    <img src="img/btn-subir.png" alt="" class="btn-subir hvr-pulse">
    </a> -->
