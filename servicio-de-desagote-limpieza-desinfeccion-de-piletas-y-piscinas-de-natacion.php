...
<section id="desagote">
      <div class="container">
              <div class="row">
                  <div class="col-md-12">   
                    <div class="div-texto">
                      <h1 class="texto1 wow zoomInDown" datos-wow-duracion= "2s" data-wow-delay = "1s">Desagote, limpieza y desinfección de piletas</h1>
                ...
                <div class="icon-sugeridos-tama wow fadeIn" datos-wow-duracion="1s" data-wow-delay="1s">
                    <table width="100%" border="0">
                      <tbody>
                        <tr>
                          <td align="center">
                            <img src="img/icon_casas.png" class="icon-suge" alt="">
                          </td>
                        </tr>
                        <tr>
                ...
                <div class="icon-sugeridos-tama wow fadeIn" datos-wow-duracion= "2.5s" data-wow-delay = "2.5s">
                    <table width="100%" border="0">
                      <tbody width="138">
                        <tr>
                          <td align="center">
                            <img src="img/icon_filtro.png" class="icon-suge" alt="">
                          </td>
                        </tr>
                        <tr>
